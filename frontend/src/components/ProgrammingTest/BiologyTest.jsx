...
const BiologyTest = () => {
    ...
    useEffect(() => {
        axios.get("http://localhost:5000/api/quizBiology")
        .then(res => {
    ...
    return (
        <Fragment>
            <div className={modalClasses.join(' ')}>
                <div className="modal-content biology">
            ...
            <div className="main-test biology">
                <div className="quiz-container">
                    <div className="question-number biology">
                        <h3>Question
                    ...
                    <div className="btn-next biology" cl onClick={validate}>
                        Next
                    </div>
